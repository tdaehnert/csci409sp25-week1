...
@app.get("/routes", dependencies=[Depends(require_auth)])
def get_routes():
    routes_list = list()
...
@app.get("/routes/{route_id}", dependencies=[Depends(require_auth)])
...
@app.get("/lines", dependencies=[Depends(require_auth)])
def get_lines():
    lines_list = list()
...
@app.get("/lines/{line_id}", dependencies=[Depends(require_auth)])
