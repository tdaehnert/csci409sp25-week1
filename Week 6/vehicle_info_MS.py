...
@app.get("/vehicles", dependencies=[Depends(require_auth)])
...
@app.get("/vehicles/{vehicle_id}", dependencies=[Depends(require_auth)])
...
@app.get("/alerts/{alert_id}", dependencies=[Depends(require_auth)])
